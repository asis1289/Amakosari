...
import { ShoppingCart, Heart, Star, Grid, List, Tag } from 'lucide-react'
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8">
            Fresh styles just in with exclusive 20% OFF!
          </p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {sortedProducts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500">Check back soon for fresh styles!</p>
          </div>
        ) : (
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Wedding Collection', discount: '30% OFF', color: 'from-pink-500 to-red-500', link: '/sale' },
              { name: 'Festival Special', discount: '25% OFF', color: 'from-purple-500 to-pink-500', link: '/sale' },
              { name: 'Engagement Collection', discount: '20% OFF', color: 'from-blue-500 to-purple-500', link: '/sale' }
              ...
              >
                ...
                <div className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg transition-colors inline-block">
                  Shop Now
                </div>
              </Link>
            ))}
